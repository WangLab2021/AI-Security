...
from GA import choiceFuction,matuingFuction,matrix_translate
...
'''
random select the obfuscate location of user3
'''
...
def genetic_algorithm(Z,p_Mating,p_Mutation,vi,lk,server_num):
    ...
    for i in range(Z):
        ...
        AM_temp = matuingFuction(AM_ga2, p_Mating, server_num, p_Mutation, S_NUM)  # mating & variation
